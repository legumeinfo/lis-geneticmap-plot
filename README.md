...
LIS Genetic Map Plot is a tool made for [BlueGenes](http://bluegenes.apps.intermine.org) following BlueGenes Tool API.

It displays a genetic map with a stack of linkage groups with markers and QTLs on a genetic map report page.
...
1. Clone the repo
2. `cd lis-geneticmap-plot` and then `npm install` to install dependencies.
